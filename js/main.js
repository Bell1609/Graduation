...
(function(html) {
    ...
    document.querySelector('button.congratulation').addEventListener('mousedown', function() {
        this.style.background = '#ffe9e9';
        this.style.transform = 'translate(0em, 0.75em)';
    });
    
    document.querySelector('button.congratulation').addEventListener('mouseup', function() {
